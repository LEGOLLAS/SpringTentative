...
<html>
	<head>
        ...
        <link rel="stylesheet" href="/css/pension/style.css" type="text/css">
    </head>
	<body>
        <div id="wrap" >
            <header class="mt-4">
                        ...
                        <div class="d-flex align-items-end">
	                        ...
	                        <div class="member-input mt-3" id="member">
	                            <div class="input-gorup form-inline">
	                                ...
	                                <input type="text" class="form-control text-input" id="name" name="name" required>
	                            </div>
	                            <div class="input-gorup form-inline mt-3">
	                                <label class="input-label">전화번호 :</label>
	                                <input type="text" class="form-control text-input" id="phoneNumber" name="phoneNumber" required>
	                            </div>
	                        </div>
                        
	                        <div class="d-flex justify-content-end">
	                            <button class="btn btn-success mt-3 mr-5" type="submit" id="lookupBtn">조회 하기</button>
	                        </div>
                    </div>
                </article>
